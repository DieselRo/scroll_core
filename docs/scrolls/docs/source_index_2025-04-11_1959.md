...
# 📦 scroll_core – Source Reference Snapshot (2025-04-11_1959)
...
fn main() {
    match initialize_scroll_core() {
        Ok(scrolls) => {
            ...
            // Create context frame engine and herald
            let engine = ContextFrameEngine::new(&archive, ContextMode::Narrow);
            let registry = scroll_core::core::construct_registry::ConstructRegistry::new(); // eventually prefill this
            let manager = InvocationManager::new(registry);
            let aelren = AelrenHerald::new(engine, vec![]); // snapshot not wired yet
