...
mod tests {
    ...
    async fn test_create_session() {
        ...
        let session = service
            .create_session(app_name, user_id, None, Some(session_id))
            .await
            .unwrap();
    ...
    async fn test_update_session_state() {
        ...
        service
            .update_session_state(&mut session, state)
            .await
            .unwrap();
    ...
    async fn test_list_sessions() {
        ...
        service
            .create_session(app_name, user_id, None, Some("session-1"))
            .await
            .unwrap();

        service
            .create_session(app_name, user_id, None, Some("session-2"))
            .await
            .unwrap();

        // List sessions
        let response = service.list_sessions(app_name, user_id).await.unwrap();
